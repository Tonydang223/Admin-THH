...
export default function MainPost() {
  ...
  const deleteAll = async () => {
    ...
    setTimeout(async () => {
      ...
      if (recycles) {
        await deletePost({ ids: selectedRowKeys }).unwrap();
      } else {
        await deletePostRestore({ ids: selectedRowKeys }).unwrap();
      }
      setLoading({
        ...loading,
        delSel: false,
  ...
  const restoreAll = async () => {
    ...
    setTimeout(async () => {
      ...
      await deletePostRestoreBack({ ids: selectedRowKeys }).unwrap();
        ...
        <Space size="middle">
          ...
          <Button
            ...
            onClick={async () => {
              if (recycles) {
                const dt = [post._id];
                await deletePostRestoreBack({ ids: dt }).unwrap();
                setSelectedRowKeys([]);
              } else {
