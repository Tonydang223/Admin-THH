...
export default function Courses() {
  ...
  const deleteAll = async () => {
    ...
    setTimeout(async () => {
      ...
      if (recycles) {
        await deleteCourse({ ids: selectedRowKeys }).unwrap();
      } else {
        await deleteCourseRestore({ ids: selectedRowKeys }).unwrap();
      }
  ...
  const restoreAll = async () => {
    ...
    setTimeout(async () => {
      ...
      await deleteCourseRestoreBack({ ids: selectedRowKeys }).unwrap();
